...
class Logger:
	...
	class __Logger:
		...
		def debug(self, log_text, logger="", should_print=False):
			self.log(log_text, logger, should_print, level="DEBUG")
		def info(self, log_text, logger="", should_print=False):
		def warning(self, log_text, logger="", should_print=False):
		def error(self, log_text, logger="", should_print=False):
		def critical(self, log_text, logger="", should_print=False):
